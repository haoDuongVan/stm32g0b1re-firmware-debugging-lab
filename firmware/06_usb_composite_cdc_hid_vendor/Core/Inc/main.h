...
#define MATRIX_ROW0_Pin GPIO_PIN_0
#define MATRIX_ROW0_GPIO_Port GPIOB
#define MATRIX_ROW1_Pin GPIO_PIN_1
...
#define MATRIX_ROW3_Pin GPIO_PIN_3
#define MATRIX_ROW3_GPIO_Port GPIOB
#define MATRIX_COL0_Pin GPIO_PIN_4
#define MATRIX_COL0_GPIO_Port GPIOB
#define MATRIX_COL1_Pin GPIO_PIN_5
#define MATRIX_COL1_GPIO_Port GPIOB
#define MATRIX_COL2_Pin GPIO_PIN_6
#define MATRIX_COL2_GPIO_Port GPIOB
#define MATRIX_COL3_Pin GPIO_PIN_7
