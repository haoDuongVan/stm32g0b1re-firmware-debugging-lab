...
rem ============================================================================
rem flash_metadata_pending_b.bat
rem
rem Generate metadata with active_slot=B, confirmed_slot=A and flash it to
rem Metadata Page 0.
rem
rem This simulates a pending OTA update: Slot B has the new firmware but has
rem not been confirmed by the application yet.
rem
rem Expected result:
rem   - metadata_magic=OK
rem   - active_slot=B
rem   - confirmed_slot=A
rem   - metadata_crc_check=OK
rem   - update_state=PENDING
...
set "METADATA_BIN=%METADATA_DIR%\metadata_pending_b.bin"
...
echo.
echo ===============================================================================
echo Project 04 metadata pending Slot B flash started
echo ===============================================================================
...
rem ----------------------------------------------------------------------------
echo.
echo [FLASH] metadata_pending_b.bin -^> %METADATA_ADDR%
...
echo.
echo ===============================================================================
echo Project 04 metadata pending Slot B flash finished successfully
echo ===============================================================================
echo.
